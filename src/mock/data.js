...
export const aboutData = {
  ...
  techSkills: [
    ...
    { icon: 'backbone.png', name: 'Backbone.js' },
    { icon: 'coffeescript.png', name: 'CoffeeScript' },
    { icon: 'preact.png', name: 'Preact' },
    { icon: 'underscore.png', name: 'Underscore.js' },
    { icon: 'jquery.png', name: 'jQuery' },
    { icon: 'handlebars.png', name: 'Handlebars' },
    ...
    { icon: 'gitlab.png', name: 'GitLab' },
    { icon: 'jira.png', name: 'Jira' },
    { icon: 'agile.png', name: 'Agile Dev' },
    { icon: 'vs-code.png', name: 'VS Code' },
    { icon: 'rubymine.png', name: 'RubyMine' },
